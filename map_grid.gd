...
var terrain_height_color_map: Gradient = preload("res://height_color_gradient.tres")
# Set noise-based elevation gradient in the editor
var terrain_height_scale_map: Gradient = preload("res://noise_height_gradient.tres")
